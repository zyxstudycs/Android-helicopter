...
public class GamePanel extends SurfaceView implements SurfaceHolder.Callback
{
    ...
    public void surfaceCreated(SurfaceHolder holder){
        ...
        bg = new Background(Source.getBackground());
        player = new Player(BitmapFactory.decodeResource(getResources(), R.drawable.helicopter2), 65, 25, 3);
...

    {
        if(player.getPlaying()) {
            ...
            if(missileElapsed >(Source.getEclapseTime() - player.getScore()/4)){
